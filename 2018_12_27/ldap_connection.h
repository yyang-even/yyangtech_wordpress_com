...
public:
    ...
    void Search(const std::string &base, const ber_int_t &scope,
    ...
    int LdapSetOption(const int option, const void *invalue) const {
        return ldap_set_option(mLdap.get(), option, invalue);
    }
